...
def open_catalog_menu(m):
    ...
    if m.text == "📚 Methods":
        ...
        kb.add(
            InlineKeyboardButton("🆓 Free Products", callback_data="shopcat|free"),
            InlineKeyboardButton("💵 Paid Products", callback_data="shopcat|paid"),
        )
        kb.add(InlineKeyboardButton("🧾 My Product Orders", callback_data="shoporders|mine"))
        raw_bot.send_message(m.from_user.id, "🛍 PRODUCTS\n\nDigital products are delivered instantly from stock after purchase.\nPaid products use your approved USDT account balance.", reply_markup=kb)
